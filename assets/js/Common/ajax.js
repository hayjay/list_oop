var LIST = {
    ...
    ajaxLoad: function (url, placeholder) {
        ...
        this.APP_XHR = $.ajax({
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                LIST.ajax_error(jqXHR.status, errorThrown);
            }
        });
    },
    ...
    LIST_dropdown: function (placeholder, data, empty_text) {
        // Data: id->value
        $(placeholder).empty();
    ...
    LIST_dropdown_map: function (placeholder, data, empty_text, selected_value) {
        // Data: id->value
        $(placeholder).empty();
        var options = "";
        if (empty_text != '')
    ...
    clearLISTForm: function (form_id) {
        $(':input', '#' + form_id)
    ...
    LIST_dropdown_map_with_title: function (placeholder, data, empty_text, selected_value,configuration) {
        // Data: id->value
        ...
        if(LIST.isEmpty(configuration.key) || LIST.isEmpty(configuration.value) || LIST.isEmpty(configuration.title)){
        ...
        $.each(data, function (i, v) {
            if(LIST.isEmpty(v[configuration.key]) || LIST.isEmpty(v[configuration.value])){
